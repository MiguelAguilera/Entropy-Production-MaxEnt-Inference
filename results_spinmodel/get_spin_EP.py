...
#    gc.collect()
    ...
    t0 = time.time()
    sig_hat_g, theta_hat_g, sig_hat_g_trn = ep_estimators.get_EP_Newton(trn,test_data=tst, validation_data=val, max_iter=1, trust_radius=None, num_chunks=num_chunks)
